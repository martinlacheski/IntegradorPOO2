    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success color-palette">
                <h4 class="modal-title" >Dar de alta a Usuario</h4>
            ...
            <div class="modal-body">
                ...
                <div class="card-footer">
                    <button id="buttonAlta" type="button" idObj="" onclick="altaObjeto_usuario(this)" class="btn btn-success float-right">Dar de Alta</button>
