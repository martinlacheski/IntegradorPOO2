                ...
                <form id="habitacionForm" action="../../SvTipoHabitacion" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="tipoHabNombre" type="text" name="tipoHabNombre" class="form-control"<br>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button id ="btnAddHabitacion" type="submit" class="btn btn-primary float-right">Agregar Tipo Habitación</button>
