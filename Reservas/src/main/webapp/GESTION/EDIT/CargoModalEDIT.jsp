                ...
                <form id="cargoForm" action="../../SvCargo" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input readonly id="cargoNombre_edit" name="cargo" type="text" class="form-control"><br>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button onclick="modificarObjeto()"type="button" class="btn btn-primary float-right">Modificar Cargo</button>
